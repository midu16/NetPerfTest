 ...
 *
 * Maximum iterations: ~10,000 (100 outer × 100 inner loops)
 ...
 * Reduced to stay within BPF instruction limits while maximizing CPU work
 */
 ...
 * 
 * Optimized: ~20 operations per iteration, stays within BPF instruction limits
 */
